...
:keywords: DNT, Guidelines, RESTful, API, Events, Schema
...
= DNT RESTful API and Event Scheme Guidelines
Den Norske Turistforening / The Norwegian Trekking Association / link:https://www.dnt.no/[dnt.no]

Other formats: link:dnt-guidelines.pdf[PDF], link:dnt-guidelines.epub[EPUB3]

Based on the excellent work by link:https://github.com/zalando/restful-api-guidelines[Zalando].
