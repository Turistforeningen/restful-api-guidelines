= Developing Restful APIs: A Comprehensive Set of Guidelines by DNT

Latest published version:
http://turistforeningen.github.io/restful-api-guidelines/[*HTML*],
http://turistforeningen.github.io/restful-api-guidelines/dnt-guidelines.pdf[*PDF*],
http://turistforeningen.github.io/restful-api-guidelines/dnt-guidelines.epub[*EPUB3*]
...
the DNT Tech team has created this comprehensive set of guidelines.
